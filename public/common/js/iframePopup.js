$(document).ready(function () {
    ...
    $("#viewApprovers").on('show.bs.modal', function (e) {
        var parent = $(e.relatedTarget);
        var height = parent.attr('data-height');
        var url = parent.attr('data-url');
        var width = parent.attr('data-width');
        $("#viewApprovers iframe").attr(
                {
                    'src': url,
                    'height': height,
                    'width': width
    ...
    $("#viewSharedDetails").on('show.bs.modal', function (e) {
        var parent = $(e.relatedTarget);
        var height = parent.attr('data-height');
        var url = parent.attr('data-url');
        var width = parent.attr('data-width');
        $("#viewSharedDetails iframe").attr(
                {
                    'src': url,
                    'height': height,
                    'width': width
    ...
    $("#previewSanctionLetter").on('show.bs.modal', function (e) {
        var parent = $(e.relatedTarget);
        var height = parent.attr('data-height');
        var url = parent.attr('data-url');
        var width = parent.attr('data-width');
        $("#previewSanctionLetter iframe").attr(
                {
                    'src': url,
                    'height': height,
                    'width': width
