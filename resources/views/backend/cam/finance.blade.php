...
@include('layouts.backend.partials.admin-menu')

<div class="content-wrapper">
    @include('layouts.backend.partials.admin-nav')
            ...
            <div class="card-body ">
                ...
                <table class="table table-bordered overview-table mt-3 " cellspacing="0">
                    <tbody><tr>
                        ...
                        <td bgcolor="#efefef" align="right">31-March-2017</td>
                        <td bgcolor="#efefef" align="right">31-March-2018</td>
                        <td bgcolor="#efefef" align="right">31-March-2019</td>

                    </tr>
                    <tr>

                        <td bgcolor="#efefef" align="right"><select class="form-control">
