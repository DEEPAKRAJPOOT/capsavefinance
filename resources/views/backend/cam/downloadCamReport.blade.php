   ...
   <div class="card-body pt-3 pb-3">
      <div class="row">
         <div class="col-md-12">
            ...
            <table id="invoice_history" class="table   no-footer overview-table " role="grid" aria-describedby="invoice_history_info" cellpadding="0" cellspacing="0">
               ...
               <tbody>
                  <tr role="row" class="odd">
                     ...
                     <td class="">Pre-disbursement</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="">Inspection of Assets</td>
                     <td class="">As per CFPL policy</td>
                  </tr>
                  <tr role="row" class="odd">
                  ...
                  <tr role="row" class="odd">
                     <td class="">Personal guarantee of Anand Desai</td>
                     <td class="">Pre-disbursement</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="">Debt /PBDIT&lt;3.5x from FY21 onwards</td>
                     <td class="" rowspan="4">Monitoring</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="">Min DSCR of 1.25x (including ECB repayment) from FY21 onwards</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="">Default with any other lender or facility provider will tantamount to default with CFPL also</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="" valign="top">Minimum EBIDTA of Rs 200Cr from FY21 onwards.</td>
                  </tr>
                  <tr role="row" class="odd">
                     <td class="">No Downgrade in credit rating below Crisil A-</td>
                     <td class="">
                     </td>
                  </tr>
               </tbody>
            ...
            <table id="invoice_history" class="table   no-footer overview-table " role="grid" aria-describedby="invoice_history_info" cellpadding="0" cellspacing="0">
               ...
               <tbody>
                  <tr>
                     ...
                     <td>No</td>
                     <td>Public Limited Company(Unlisted)</td>
                  </tr>
                  <tr>
                     <td>Vintage</td>
                     <td>
                     ...
                     <td>No</td>
                     <td>17 years (INC : Sept 30, 2003)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td>No</td>
                     <td>2019: Rs. 7276.11 Mn<br>2018: Rs. 4412.59 Mn<br>2017: Rs. 2443.25 Mn</td>
                  </tr>
                  <tr>
                     <td>Cash Profit</td>
                     <td>Positive for 2 out of last 3 financial years(positive in last year)</td>
                     <td>No</td>
                     <td>2019: Rs. 727.45 Mn<br>2018: Rs. 574.35 Mn<br>2017: Rs. 501.65 Mn</td>
                  </tr>
                  <tr>
                     <td>DSCR</td>
                     <td>&gt;1.2X</td>
                  ...
                  <tr>
                     ...
                     <td>• High risk<br>• Low Risk<br>• Medium Risk</td>
                     <td>No</td>
                     <td>Medium risk</td>
                  </tr>
                  <tr>
            ...
            <table id="invoice_history" class="table   table-striped no-footer overview-table " role="grid" aria-describedby="invoice_history_info" cellpadding="0" cellspacing="0">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>Rated by CRISIL A-/Stable/A2+ (upgraded from CRISIL BBB+ / Stable/A2) on Oct 04, 2019</td>
                  </tr>
                  <tr>
                     <td>6</td>
            ...
            <p>Anupam Rasayan as a partnership firm was started by Suresh Chandra Desai (father of Anand Desai) along with 
               Ashwin Desai (maternal uncle of Anand Desai) with 50% partnership each in 1977 for manufacturing and trading of 
               bulk chemicals such as caustic soda, sulphuric acid etc. The firm was converted to a private limited company in the 
               form of Anupam Rasayan India Limited (ARIL) in 2003 keeping the shareholding between the two partners to 50% 
               each. Post the death of Mr. Suresh Chandra Desai, his son Mr. Anand Desai took over as the CEO of the company 
               and continue to be so currently. In 2012 Mr. Ashwin Desai took an exit from the company and his shareholding was 
               partially bought over By Milan Thakkar and the balance was bought over by Anand Desai and his family. Mr Milan 
               Thakkar was one of the customers to ARIL and therefore was keen on being part of the ARIL setup and venture into 
               specialty chemicals. Further in FY17 for expansion of product portfolio and building up new facilities for the same, 
               the company got investment from Kiran Pallavi Investment Fund, which was the proprietary fund of Mr Kiran 
               Patel(US Based Billionaire) to the tune of Rs.2700 Mn(in two tranches as discussed above) for a 36% stake in the 
               company.
            </p>
            ...
            <p>Mr. Anand Desai has been the pioneer of the company for moving the company into manufacturing of specialty and fine chemicals on contract manufacturing basis for large customers mainly MNCs. The company is currently one of the established players in manufacturing of fine and specialty chemicals catering to multiple industries such as Pharmaceuticals, Agriculture, Personal Care and Polymer industries. Over a period of time ARIL has grown gradually and established itself as a company that manufactures specialized chemical products with world class manufacturing locations (certified for ISO 9001:2015 and ISO 14001:2015). Research &amp; Development is the key function of ARIL due to which the company has been able to introduce numerous products for the first time in India, on an exclusive basis for customers such as BASF, Sumitomo, Dow Chemicals, Syngenta etc.</p>
            <p>On account of investment from Kiran Pallavi Investment LLC, Dr Kiran Patel is in the board as one of the directors. Dr. Kiran Patel is American based Cardiologist, businessman and philanthropist and along with his wife Ms. Pallavi Patel have floated the Kiran Pallavi Investment LLC for their investments in India. In India they have only investment
               i.e. in ARIL.
            </p>
