                                         ...
                                         <table class="table table-bordered overview-table mt-3" cellpadding="0" cellspacing="0" border="1">
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <div class="file-browse float-left position-seta">
                                                        ...
                                                        <a  href="{{ isset($panNoFileId[$j]) ? route('download_s3_file', ['file_id' => $panNoFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($panNoFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                                    </div>  
                                                </td>
                                             </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="file-browse float-left position-seta">
                                                        ...
                                                        <a  href="{{ isset($dlNoFileId[$j]) ? route('download_s3_file', ['file_id' => $dlNoFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($dlNoFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                                    </div>            
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="file-browse float-left position-seta">
                                                        ...
                                                        <a  href="{{ isset($voterNoFileId[$j]) ? route('download_s3_file', ['file_id' => $voterNoFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($voterNoFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                                    </div>                
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="file-browse float-left position-seta">
                                                        ...
                                                        <a  href="{{ isset($passNoFileId[$j]) ? route('download_s3_file', ['file_id' => $passNoFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($passNoFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                                    </div>               
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a  href="{{ isset($photoFileId[$j]) ? route('download_s3_file', ['file_id' => $photoFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($photoFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a  href="{{ isset($aadharFileId[$j]) ? route('download_s3_file', ['file_id' => $aadharFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($aadharFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a  href="{{ isset($electricityFileId[$j]) ? route('download_s3_file', ['file_id' => $electricityFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($electricityFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a  href="{{ isset($telephoneFileId[$j]) ? route('download_s3_file', ['file_id' => $telephoneFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($telephoneFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td><a  href="{{ isset($ckycFileId[$j]) ? route('download_s3_file', ['file_id' => $ckycFileId[$j] ]) : '' }}" class="btn-upload   btn-sm" type="button"  style="display:{{ isset($ckycFilePath[$j]) ? 'inline' : 'none'}}"> <i class="fa fa-download"></i></a>&nbsp;&nbsp;</td>
                                                        <td>
