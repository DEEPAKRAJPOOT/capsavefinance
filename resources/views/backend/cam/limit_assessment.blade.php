                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group INR">
                                    ...
                                    @if(($userRole->name == 'Credit Manager' || $userRole->name == 'Super Admin') && $userInfo->assignee_role == 'Credit Manager' && isset($limitData->tot_limit_amt) && ($appStatus == 56 || $appStatus == 20 || $appStatus == 49))
                    ...
                    @can('save_limit_assessment')
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd">
                                                       ...
                                                       @can('delete_prgm_limit')
                                                        @if(($userRole->name == 'Credit Manager' || $userRole->name == 'Super Admin') && $userInfo->assignee_role == 'Credit Manager' &&($appStatus == 56 || $appStatus == 20 || $appStatus == 23 || $appStatus == 49) && ($prgmLimit->offer->count() == 0))
					    ...
					    @if ( ($userRole && $userRole->id == 11 && \Auth::user()->anchor_id == $prgmOffer->anchor_id) || (!$userRole || ($userRole && $userRole->id != 11)) )
                                                ...
                                                <td>
                                                    ...
                                                    @if(($userRole->name == 'Credit Manager' || $userRole->name == 'Super Admin') &&$userInfo->assignee_role == 'Credit Manager' && ($appStatus == 56 || $appStatus == 20 || $appStatus == 23 || $appStatus == 49))
