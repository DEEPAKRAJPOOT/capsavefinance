         ...
         <table id="invoice_history" class="table   no-footer overview-table " role="grid" aria-describedby="invoice_history_info" cellpadding="0" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>Max 15% of Net owned funds @if($borrowerLimitData['single_limit'] !== 0) (Rs {{$borrowerLimitData['single_limit']}} Mn) @endif</td>
               ...
               <tr>
                  ...
                  <td>Max 25% of Net owned funds @if($borrowerLimitData['multiple_limit'] !== 0) (Rs {{$borrowerLimitData['multiple_limit']}} Mn) @endif</td>
