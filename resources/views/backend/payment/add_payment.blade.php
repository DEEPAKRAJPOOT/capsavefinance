    ...
    $(document).ready(function() {
        ...
        $("#payment_type").on('change', function() {
            ...
            if (status == 1) {
                ...
                $('#appendInput').append('<label for="repaid_amount" class="form-control-label"><span class="payment_text">Cheque Number</span></label><span class="error_message_label">*</span><input type="text" class="form-control amountRepay" id="utr_no" name="utr_no" value=""><span id="utr_no_msg" class="error"></span>  <div class="col-md-4 tds_certificate"><div class="custom-file upload-btn-cls mb-3 mt-4"><input type="file" class="custom-file-input getFileName doc_file" id="cheque" name="cheque" multiple=""><label class="custom-file-label" for="cheque">Upload Cheque</label></div></div><span id="utr_no_msg" class="error"></span>');
