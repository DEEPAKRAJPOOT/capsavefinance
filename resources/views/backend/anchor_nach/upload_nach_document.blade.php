...
@section('content')
<form id="documentForm" style="width: 100%" method="POST" action="{{ Route('anchor_nach_document_save', ['user_id' => request()->get('user_id'), 'users_nach_id' => request()->get('users_nach_id')]) }}" enctype="multipart/form-data" target="_top">       
    @csrf
