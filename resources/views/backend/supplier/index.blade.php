                                    ...
                                    <table id="supplier-listing" class="table white-space table-striped cell-border dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="supplier-listing_info" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="white-space numericCol sorting">Recommended Limit (₹)</th>
                                                <th class="white-space sorting">Created By</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>AJIT SINGH HARBANS SINGH KOHLI</td>
                                                ...
                                                <td><a href="#" class="btn btn-primary btn-sm">Edit</a> <a href="#" class="btn btn-info btn-sm">Invoice Setting</a></td>
                                            </tr>
