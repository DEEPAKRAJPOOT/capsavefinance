...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('save_new_sanction_letter')}}" method="post" id="new_sanction_letter_form">
                        @csrf
                        <div class=" form-fields">
                            ...
                            <div class="form-group mb-0 mt-5 justify-content-between pull-right">
                                {{-- <button type="button" class="btn btn-default mr-2" id="preview_invoice">Preview</button> --}}
                                ...
                                <button type="submit" class="btn btn-default mr-2" name="action_type" id="update_invoice" value="update">Update</button>
                                @endif
                                <button type="submit" class="btn btn-primary mr-2" name="action_type" id="save_invoice" value="final_submit">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
