								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="biz_pan_number" value="{{old('biz_pan_number', $business_info->pan->pan_gst_hash)}}" class="form-control" tabindex="7" placeholder="Enter Company Pan" required readonly>
