                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <a class="verify-owner-no verify-show verify_mobile_no" name="verify_mobile_no" id="verify_mobile_no" >Verify</a>
                                        <input type="text" name="mobile_no[]" maxlength='10' id="mobile_no" value="{{$row->mobile_no}}" class="form-control"  placeholder="Enter Mobile no">
                                    </div>
                                </div>
                            </div>
