		...
		<div class="card">
			<div class="card-body">
			  <div class=" form-fields">
			   <div class="col-md-12">
				<h5 class="card-title form-head-h5">Promoter Details  </h5>
				<button class="close close-cls" type="button">x</button>
											<div class="row">
											
											<div class="col-md-12">
													<div class="form-group">
														<label for="txtCreditPeriod">Promoter Type

															<span class="mandatory">*</span>
														</label>
							<input type="text" name="employee" id="employee" class="form-control" value = "Co-Applicant" disabled>
													</div>
												</div>
