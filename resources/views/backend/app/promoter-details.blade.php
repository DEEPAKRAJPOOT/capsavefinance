                                    ...
                                    <div class="prtm-full-block">       
                                        <div class="prtm-block-content">
                                            <div class="table-responsive ps ps--theme_default" data-ps-id="9615ce02-be28-0492-7403-d251d7f6339e">
                                                <table class="table text-center table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <span class="text-danger" id="v1failurepanverify{{isset($row->first_name) ? $i : '1'}}" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> <i>Not Verified</i> </span>
                                                                    ...
                                                                    <input type="text" {{ isset($panNo->requestId) ? "readonly='readonly'" : '' }} value="{{ isset($panNo->requestId) ? $panNo->requestId : '' }}"  name="veripan[]" id="veripan{{isset($row->first_name) ? $i : '1'}}"  class="form-control verifydl" tabindex="1" placeholder="Enter PAN Number">
                                                                </div>
                                                            </td>
                                                            <td width="28%">
                                               ...
                                               <span class="text-success" id="v2successpanverify{{isset($row->first_name) ? $i : '1'}}" style="display:{{isset($dlNo->requestId) ? 'inline' : 'none'}}"><i class="fa fa-check-circle" aria-hidden="true"></i> <i>Verified Successfully</i> </span>

                                            <span class="text-danger" id="v2failurepanverify{{isset($row->first_name) ? $i : '1'}}" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> <i>Not Verified</i> </span>
                                                 <a href="javascript:void(0);" id='ddriving{{isset($row->first_name) ? $i : '1'}}' data-id="{{isset($row->first_name) ? $i : '1'}}" class="verify-owner-no verify-show veridl" style="top:0px; pointer-events:{{ (isset($dlNo->requestId)) ? 'none' : ''}}">{{ isset($dlNo->requestId) ? 'Verified' : 'Verify' }}</a>
                                                        <input type="text" {{ isset($dlNo->requestId) ? "readonly='readonly'" : '' }} value="{{ isset($dlNo->requestId) ? $dlNo->requestId : '' }}" name="verifydl[]" id="verifydl{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control verifydl" tabindex="1" placeholder="Enter DL Number">
                                                                </div>
                                                            </td>
                                                            <td width="28%">
                                                                <div class="file-browse float-left position-seta">
                                                ...
                                                <span class="text-success" id="v3successpanverify{{isset($row->first_name) ? $i : '1'}}" style="display:{{isset($voterNo->requestId) ? 'inline' : 'none'}}"><i class="fa fa-check-circle" aria-hidden="true"></i> <i>Verified Successfully</i> </span>

                                            <span class="text-danger" id="v3failurepanverify{{isset($row->first_name) ? $i : '1'}}" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> <i>Not Verified</i> </span>
                                                <a href="javascript:void(0);" id='vvoter{{isset($row->first_name) ? $i : '1'}}' data-id="{{isset($row->first_name) ? $i : '1'}}" class="verify-owner-no verify-show verivoter" style="top:0px; pointer-events:{{ (isset($voterNo->requestId)) ? 'none' : ''}}">{{ isset($voterNo->requestId) ? 'Verified' : 'Verify' }}</a>
                                                       
                                                            <input type="text" {{ isset($voterNo->requestId) ? "readonly='readonly'" : '' }} value="{{ isset($voterNo->requestId) ? $voterNo->requestId : '' }}" name="verifyvoter[]" id="verifyvoter{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control verifyvoter" tabindex="1" placeholder="Enter Voter's Epic Number">
                                                                </div>
                                                                </td>
                                                            <td width="28%">
                                                                <div class="file-browse float-left position-seta">
                                                  ...
                                                  <span class="text-success" id="v4successpanverify{{isset($row->first_name) ? $i : '1'}}"  style="display:{{isset($passNo->requestId) ? 'inline' : 'none'}}"><i class="fa fa-check-circle" aria-hidden="true"></i> <i>Verified Successfully</i> </span>

                                           <span class="text-danger" id="v4failurepanverify{{isset($row->first_name) ? $i : '1'}}"  style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> <i>Not Verified</i> </span>
                                               
                                                         <a href="javascript:void(0);" id='ppassport{{isset($row->first_name) ? $i : '1'}}' data-id="{{isset($row->first_name) ? $i : '1'}}" class="verify-owner-no verify-show veripass" style="top:0px; pointer-events:{{ (isset($passNo->requestId)) ? 'none' : ''}}">{{ isset($passNo->requestId) ? 'Verified' : 'Verify' }}</a>
                                                                 <input type="text"  {{ isset($passNo->requestId) ? "readonly='readonly'" : '' }}  value="{{ isset($passNo->requestId) ? $passNo->requestId : '' }}" name="verifypassport[]" id="verifypassport{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control verifypassport" tabindex="1" placeholder="Enter File Number">
                                                                </div>
                                                                </td>
                                                            <td width="28%">
                                                                <div class="file-browse float-left position-seta">
