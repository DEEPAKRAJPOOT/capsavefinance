                                                ...
                                                <table class="table text-center table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30%" >
                                                                <div class="col-md-12">
                                                                    <a href="javascript:void(0);" id='vvoter{{isset($row->first_name) ? $i : '1'}}' class="verify-owner-no verify-show" style="top:0px;">Verify</a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30%" >
                                                                <div class="col-md-12">
                                                                    <a href="javascript:void(0);" id='ppassport{{isset($row->first_name) ? $i : '1'}}' class="verify-owner-no verify-show" style="top:0px;">Verify</a>
