								...
								<div class="row">								
									...
									<div class="col-md-4">
										...
										<div class="form-group password-input">
											...
											<input type="text" name="busi_pan_comm_date" value="{{old('busi_pan_comm_date')}}" class="form-control datepicker-dis-fdate" tabindex="5" placeholder="Enter Date of commencement of business" autocomplete="off" readonly >
													...
													<div class="col-md-4">
														<div class="form-group password-input">
															...
															<select class="form-control" name="location_other_id[]" tabindex="13" >
																<option value=""> Address Label</option>
																@foreach($locationType as $key => $location)
																<option value="{{ $location->location_id }}" {{(old('location_other_id.0') == $location->location_id)? 'selected':''}}> {{$location->name}} </option>
																@endforeach
															</select>
														</div>
													</div>													
													...
													<div class="col-md-4">
														<div class="form-group password-input">
															...
															<select class="form-control" name="location_other_id[]" tabindex="13" >
																<option value=""> Address Label</option>
																@foreach($locationType as $key => $location)
																<option value="{{ $location->location_id }}" {{(old('location_other_id.1') == $location->location_id)? 'selected':''}}> {{$location->name}} </option>
																@endforeach
															</select>
														</div>
													</div>													
													...
													<div class="col-md-4">
														<div class="form-group password-input">
															...
															<select class="form-control" name="location_other_id[]" tabindex="13" >
																<option value=""> Address Label</option>
																@foreach($locationType as $key => $location)
																<option value="{{ $location->location_id }}" {{(old('location_other_id.2') == $location->location_id)? 'selected':''}}> {{$location->name}} </option>
																@endforeach
															</select>
														</div>
													</div>													
													...
													<div class="col-md-4">
														<div class="form-group password-input">
															...
															<select class="form-control" name="location_other_id[]" tabindex="13" >
																<option value=""> Address Label</option>
																@foreach($locationType as $key => $location)
																<option value="{{ $location->location_id }}" {{(old('location_other_id.3') == $location->location_id)? 'selected':''}} > {{$location->name}} </option>
																@endforeach
															</select>
														</div>
													</div>													
