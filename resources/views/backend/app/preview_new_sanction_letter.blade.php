                ...
                <div class="card-body">
                        ...
                        @if($action_type == 'preview' && !Session::has('message'))
                            ...
                            <form action="{{route('send_new_sanction_letter_on_mail')}}" method="post" id="new_sanction_letter_form" onSubmit="return submitAlert();">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm pull-right mr-2 mt-3" id="send_sanction" onclick="document.getElementById('overlay').style.display='block'">Send Mail</button>
                            </form>
                                @else 
                            @endif
                    @endif
