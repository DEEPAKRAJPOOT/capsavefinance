...
<div class="content-wrapper">
    ...
    @if($app->curr_status_id >= config('common.mst_status_id.OFFER_ACCEPTED')) --}}
    @if ($appOffer > 0)
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('save_user_invoice_location_app', ['user_id' => $user_id,'biz_id'=> $biz_id,'app_id' => $app_id] )}}" method="post"  id="invoice_location">
                        ...
                        <div class="row">
                            ...
                            {{-- @can('save_user_invoice_location_app') --}}
...
<script type="text/javascript">
   var message = {
       ...
       get_cust_and_cap_loca_app: "{{ URL::route('get_cust_and_cap_loca_app') }}",
   }
</script>
<script type="text/javascript">
...
<script type="text/javascript" src="{{ asset('backend/js/ajax-js/lms/cusCapLocationApp.js') }}"></script>
@endsection