            ...
            <div class="row ">
                <div id="accordion" class="accordion d-table col-sm-12">
                    <div class="card card-color mb-0">
                        ...
                        <div class="action-btn">
                            <div class="upload-btn-wrapper setupload-btn pos">
                                <button class="btn" data-toggle="modal" data-target="#myModal">Upload</button>
                    ...
                    <div class="card card-color mb-0">
                        ...
                        <div class="action-btn">
                            <div class="upload-btn-wrapper setupload-btn pos">
                                <button class="btn" data-toggle="modal" data-target="#myModal1">Upload</button>
                                <!--<input type="file" name="myfile">-->
                            </div>

                        </div>
                        <div id="collapse3" class="card-body collapse p-0" data-parent="#accordion">

                            <table class="table  overview-table" cellpadding="0" cellspacing="0" border="1">
                                <tbody>
                                    <tr>
                                        <td><b>Document Name</b></td>
                                        <td><b>GST Month & Year</b></td>
                                        <td><b>Upload On	</b></td>
                                        <td><b>Download</b></td>
                                        <td align="center"><b>Action</b></td>  
                                    </tr>
                                    <tr>
                                        <td>ledger_IMG-20191111-WA0014 (1).jpg</td>
                                        <td>20-June-2019</td>
                                        <td>Tue, Nov 12, 2019, 2:56 AM	</td>
                    ...
                    <div class="card card-color mb-0">
                        ...
                        <div class="action-btn">
                            <div class="upload-btn-wrapper setupload-btn pos">
                                <button class="btn" data-toggle="modal" data-target="#myModal2">Upload</button>
                                <!--<input type="file" name="myfile">-->
                            </div>

                        </div>
                        <div id="collapse10" class="card-body collapse p-0" data-parent="#accordion">
