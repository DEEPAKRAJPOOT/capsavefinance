    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                'id'=>'account_no','placeholder'=>'Enter Account Number', 'autocomplete' => 'off']) !!}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                ['class'=>'form-control form-control-sm number_format', 'id'=>'confim_acc_no', 'placeholder'=>'Enter Account Number', 'autocomplete' => 'off']) !!}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::text('ifsc_code', isset($bankAccount->ifsc_code) ? $bankAccount->ifsc_code : null,['class'=>'form-control form-control-sm' ,'placeholder'=>'Enter IFSC Code', 'id'=>'ifsc_code', 'autocomplete' => 'off']) !!}
