                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="logo_align" id="logo_align">
                                 <option value="">Please Select</option>
                                 <option value="1" {{$anchorData->logo_align == 1 ? 'selected' : ''}}>Left</option>
                                 <option value="2" {{$anchorData->logo_align == 2 ? 'selected' : ''}}>Right</option>
                              </select>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-check-inline ">
                              <label class="fnt">
                              <input type="radio" class="form-check-input is_phy_inv_req" {{$anchorData->is_phy_inv_req == 1 ? 'checked' : ''}} name="is_phy_inv_req" value="1">Yes
                              </label>
                           </div>
                           <div class="form-check-inline">
                              <label class="fnt">
