                                                    ...
                                                    <tr>
                                                       ...
                                                       <td width="15%">
                                                           <button class="btn-upload btn-sm"  style="padding: 1px 8px;" type="button"> <i class="fa fa-download"></i></button>
                                                            @if($value2->is_active)
                                                            <a<button class="btn-upload btn-sm trigger-for-rcu-doc" style="padding: 1px 8px;" type="button"> <i class="fa fa-upload"></i></button>
                ...
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <div class="form-group text-right">
                           ...
                           <a data-toggle="modal" data-target="#uploadRcuDocFrame" data-url ="{{route('rcu_upload', ['app_id' => request()->get('app_id')]) }}" data-height="150px" data-width="100%" data-placement="top" class="add-btn-cls float-right" id="openRcuDocModal" style="display: none;"><i class="fa fa-plus"></i>Upload Report</a>
