        ...
        <div class="card-body">
             ...
             <div class="col-md-2">		    
                 ...
                 <select readonly="readonly" class="form-control form-control-sm searchbtn" id="supplier_id" name="search_supplier">
                      ...
                      <div class="col-md-2">	
 <button type="button" class="btn btn-success btn-sm ml-2" data-toggle="modal" data-target="#myModal6"> Bulk Invoice Upload</button>
        ...
        <select readonly="readonly" class="form-control changeBulkAnchor" id="anchor_bulk_id"  name="anchor_bulk_id">
		 ...
		 <div class="col-md-6">
           ...
           <select readonly="readonly" class="form-control" id="supplier_bulk_id" name="supplier_bulk_id">
            ...
            <a href="{{url('backend/assets/invoice/invoice-template.xls')}}" class="mt-1 float-left"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download Template</a>
            </div>
            </div>
