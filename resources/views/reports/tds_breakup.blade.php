...
@section('content')
@include('layouts.backend.partials.admin_reports_links',['active'=>'tds_breakup'])
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h3>Reports</h3>
            <small>TDS Break up Report</small>
        </div>
    </section>
        ...
        <div class="card-body">
            <div class="row mt-4">
                ...
                <div class="col-12 dataTables_wrapper mt-4">
                    <div class="overflow">
                        <div id="tds_breakup_listing_reports" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="table-responsive ps ps--theme_default"
                                        data-ps-id="0b57d57f-c517-e65f-5cf6-304e01f86376">
                                        <table id="tds_breakup_report"
                                            class="table table-striped cell-border dataTable no-footer overview-table"
                                            cellspacing="0" width="100%" role="grid"
                                            aria-describedby="tds_breakup_report_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    <th>Loan #</th>
                                                    <th>Client Name</th>
                                                    <th>Interest/Charge Amount (₹)</th>
                                    ...
                                    <div id="tds_breakup_report_processing" class="dataTables_processing card"
...
<script>
    var messages = {
        get_all_tds_breakups: "{{ URL::route('get_all_tds_breakups') }}",
        data_not_found: "{{ trans('error_messages.data_not_found') }}",
        get_customer: "{{ route('get_customer') }}",
        token: "{{ csrf_token() }}",
    };
</script>
<script src="{{ asset('backend/js/Reports/tds_breakup.js') }}" type="text/javascript"></script>
@endsection