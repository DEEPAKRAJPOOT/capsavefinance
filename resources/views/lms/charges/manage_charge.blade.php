                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table id="chargesList" class="table white-space table-striped cell-border no-footer overview-table" cellspacing="0" width="100%" role="grid" aria-describedby="supplier-listing_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
                                    <th><input type="checkbox" onclick="toggleAllCheckboxes();" id="selectAllCharges"></th>
                                    <th>Charge Name</th>
                                    <th>Charge Type</th>
...
var messages = {
    ...
    token: "{{ csrf_token() }}",
    lms_req_for_chrg_deletion: "{{ URL::route('lms_req_for_chrg_deletion') }}",
    lms_approve_chrg_deletion: "{{ URL::route('lms_approve_chrg_deletion') }}",
};
