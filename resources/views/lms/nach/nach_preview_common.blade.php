                            ...
                            <tr>
                                <td valign="top" style="width: 110px;">
                                    <table style="border: 1px solid #ddd; padding: 10px;">
                                        ...
                                        <tr>
                                            <td style="vertical-align:top;"><span style="border: 1px solid #ddd; height: 18px;width: 18px;display: inline-block;padding-left: 5px; padding-top: 1px;">@php if(isset($nachDetail['status']) && ($nachDetail['status'] == 1)) {@endphp <img src="{{$tick}}" height="10px" width="8px"> @php }@endphp</span></td>
                                            <td style="vertical-align:top;font-size:12px;"> CREATE</td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top;"><span style="border: 1px solid #ddd; height: 18px;width: 18px;display: inline-block;padding-left: 5px; padding-top: 1px;">@php if(isset($nachDetail['status']) && ($nachDetail['status'] == 2)) {@endphp <img src="{{$tick}}" height="10px" width="8px"> @php }@endphp</span></td>
                                            <td style="vertical-align:top;font-size:12px;"> MODIFY</td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top;"><span style="border: 1px solid #ddd; height: 18px;width: 18px;display: inline-block;padding-left: 5px; padding-top: 1px;">@php if(isset($nachDetail['status']) && ($nachDetail['status'] == 3)) {@endphp <img src="{{$tick}}" height="10px" width="8px"> @php }@endphp</span></td>
