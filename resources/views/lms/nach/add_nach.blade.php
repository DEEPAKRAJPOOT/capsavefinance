...
<div class="content-wrapper">
	<div class="row grid-margin mt-3">
		<div class="  col-md-12  ">
                     <div class="card">
                        @php
                            $users_nach_id = isset($nachDetail[0]) && ($nachDetail[0]['frequency'] > 0) ? $nachDetail[0]['users_nach_id'] : null;
                        @endphp
			<div class="card">
                                <form id='nach_form' method="post" action="{{route('save_nach_detail', ['acc_id' => $acc_id, 'user_id' => $user_id, 'users_nach_id' => $users_nach_id])}}">
				@csrf
                                <div class="card-body">
                                    <div class="row">
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <ul class="custom-check-label">
                                                    <li>
                                                        <input id='frequency' type="radio" name="frequency" value='1' {{ isset($nachDetail[0]) && ($nachDetail[0]['frequency'] == 1) ? 'checked' : '' }}>
                                                        {!! $errors->first('frequency', '<span class="error">:message</span>') !!}
                                                        <label for="frequency">Monthly
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="frequency" value='2' {{ isset($nachDetail[0]) && ($nachDetail[0]['frequency'] == 2) ? 'checked' : '' }}>
                                                        {!! $errors->first('frequency', '<span class="error">:message</span>') !!}
                                                        <label for="frequency">Quaterly
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="frequency" value='3' {{ isset($nachDetail[0]) && ($nachDetail[0]['frequency'] == 3) ? 'checked' : '' }}>
                                                        {!! $errors->first('frequency', '<span class="error">:message</span>') !!}
                                                        <label for="frequency">Half Yearly
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="frequency" value='4' {{ isset($nachDetail[0]) && ($nachDetail[0]['frequency'] == 4) ? 'checked' : '' }}>
                                                        {!! $errors->first('frequency', '<span class="error">:message</span>') !!}
                                                        <label for="frequency">Yearly
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="frequency" value='5' {{ isset($nachDetail[0]) && ($nachDetail[0]['frequency'] == 5) ? 'checked' : '' }}>
                                                        {!! $errors->first('frequency', '<span class="error">:message</span>') !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('nach_date', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['nach_date'] != '') ? \Carbon\Carbon::parse($nachDetail[0]['nach_date'])->format('d/m/Y') : ''
					...
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <ul class="custom-check-label">
                                                    <li>
                                                        <input id='debit_tick' type="radio" name="debit_tick" value='1' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_tick'] == 1) ? 'checked' : '' }}>
                                                        {!! $errors->first('debit_tick', '<span class="error">:message</span>') !!}
                                                        <label for="debit_tick">SB
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input id='debit_tick' type="radio" name="debit_tick" value='2' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_tick'] == 2) ? 'checked' : '' }}>
                                                        {!! $errors->first('debit_tick', '<span class="error">:message</span>') !!}
                                                        <label for="debit_tick">CA
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input id='debit_tick' type="radio" name="debit_tick" value='3' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_tick'] == 3) ? 'checked' : '' }}>
                                                        {!! $errors->first('debit_tick', '<span class="error">:message</span>') !!}
                                                        <label for="debit_tick">CC
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <input id='debit_tick' type="radio" name="debit_tick" value='4' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_tick'] == 5) ? 'checked' : '' }}>
                                                        {!! $errors->first('debit_tick', '<span class="error">:message</span>') !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('amount', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['amount'] != '') ? $nachDetail[0]['amount'] : ''
					...
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('phone_no', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['phone_no'] != '') ? $nachDetail[0]['phone_no'] : ''
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('email_id', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['email_id'] != '') ? $nachDetail[0]['email_id'] : ''
					...
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('reference_1', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['reference_1'] != '') ? $nachDetail[0]['reference_1'] : ''
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('reference_2', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['reference_2'] != '') ? $nachDetail[0]['reference_2'] : ''
					...
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <ul class="custom-check-label">
                                                    <li>
                                                        <input type="radio" name="debit_type" value='1' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_type'] == 1) ? 'checked' : '' }}>
                                                        <label for="debit_type">Fixed Amount
                                                        {!! $errors->first('debit_type', '<span class="error">:message</span>') !!}
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="debit_type" value='2' {{ isset($nachDetail[0]) && ($nachDetail[0]['debit_type'] == 2) ? 'checked' : '' }}>
                                                        {!! $errors->first('debit_type', '<span class="error">:message</span>') !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('period_from', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['period_from'] != null) ? \Carbon\Carbon::parse($nachDetail[0]['period_from'])->format('d/m/Y') : ''
					...
					<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('period_to', 
                                                 isset($nachDetail[0]) && ($nachDetail[0]['period_to'] != null) ? \Carbon\Carbon::parse($nachDetail[0]['period_to'])->format('d/m/Y') : ''
                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="custom-check-label">
                                                    <li>
                                                        ...
                                                        1,
                                                        isset($nachDetail[0]) && ($nachDetail[0]['period_until_cancelled'] == 1) ? 'checked' : ''
					...
					<div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            @if (!isset($nachDetail[0]))
                                                <input class="btn btn-success btn-sm pull-right" type='submit' name='submit' value='submit'>
                                            @else
