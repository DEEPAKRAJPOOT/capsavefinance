<div class="row">
    <div class="col-md-4 Lh-3"><b>Customer ID:</b> <a href="{{
       route('lms_get_customer_applications', ['user_id' => $userDetails['user_id'] ])}}" id="{{$userDetails['user_id']}}"> {{ $userDetails['customer_id']}}</a></div>
