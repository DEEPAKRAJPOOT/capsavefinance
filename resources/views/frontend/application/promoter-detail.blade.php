                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="txtCreditPeriod">Last Name
                                         ...
                                         <input type="text" name="last_name[]" id="last_name{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control last_name" placeholder="Enter Last Name" >
                                                     </div>
                                </div>
 <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="txtCreditPeriod">PAN Number
                                                            ...
                                                            <span class=" text-success" id="successpanverify{{isset($row->first_name) ? $i : '1'}}" style="display:none;"><i class="fa fa-check-circle" aria-hidden="true"></i> <i>Verified Successfully</i> </span>
                                                          
                                                            <span class="mandatory">*</span>
                                                        </label>
                                                        <a href="javascript:void(0);" data-id="{{isset($row->first_name) ? $i : '1'}}" id="pan_verify{{isset($row->first_name) ? $i : '1'}}" class="verify-owner-no promoter_pan_verify">Verify</a>
                                                        <input type="text" name="pan_no[]" id="pan_no{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control pan_no" placeholder="Enter Pan Number" >
  ...
  <div class="col-md-4">
                                                    ...
                                                    <div class="form-group password-input">
                                                        ...
                                                        <input type="text" name="share_per[]" id="share_per{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control share_per" tabindex="1" placeholder="Enter Shareholder" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="edu_qualification[]" id="edu_qualification{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control edu_qualification" tabindex="1" placeholder="Enter Education Qualification">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="other_ownership[]" id="other_ownership{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control other_ownership" tabindex="1" placeholder="Other Ownership">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group INR">
                                                        <label for="networth">Networth 
 </label> <a href="javascript:void(0);" class="verify-owner-no"><i class="fa fa-inr" aria-hidden="true"></i></a> <input type="text" name="networth[]" id="networth{{isset($row->first_name) ? $i : '1'}}" value="" class="form-control networth" tabindex="1" placeholder="Enter Networth">
                                                    </div>
                                                </div>
