                                                ...
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="14%">
                                                                @can('frontend_download_storage_file')
