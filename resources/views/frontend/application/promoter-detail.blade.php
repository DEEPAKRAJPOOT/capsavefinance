                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="14%">
                                                                ...
                                                                <div class="file-browse float-left position-seta">
                                                                    <a  href="{{ isset($main1[$j]['panNoId']) ? route('download_storage_file', ['file_id' =>$main1[$j]['panNoId'] ]) : '' }}" class="btn-upload   btn-sm" type="button" id="pandown{{isset($row->first_name) ? $i : '1'}}" style="display:{{ isset($main1[$j]['panNoFile']) ? 'inline' : 'none'}}" > <i class="fa fa-download"></i></a>
