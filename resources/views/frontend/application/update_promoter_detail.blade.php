...
<div class="content-wrapper">
    <ul class="sub-menu-main pl-0 m-0">
        ...
        <li>
                <a href="{{ route('promoter-detail', ['app_id' => request()->get('app_id'), 'biz_id' => request()->get('biz_id'), 'edit' => 1]) }}"  class="active">Management Details</a>
        </li>
        <li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-fields">
                        <div class="col-md-12">
                            <h5 class="card-title form-head">Management Details</h5>
                        </div>	
                    </div>	
                    <form id="signupForm">
                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="txtCreditPeriod" for="first_name" >Management Name
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group password-input">
                                                        ...
                                                        <input type="text" name="share_per[]" id="share_per{{isset($row->first_name) ? $i : '1'}}" value="{{$row->share_per}}" class="form-control share_per"  placeholder="Enter Shareholder" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group INR">
                                                        ...
                                                        </label> <a href="javascript:void(0);" class="verify-owner-no"><i class="fa fa-inr" aria-hidden="true"></i></a> <input type="text" name="networth[]" id="networth{{isset($row->first_name) ? $i : '1'}}" value="{{$row->networth}}" class="form-control networth"  placeholder="Enter Networth">
                                                    </div>
                                                </div>
...
@section('jscript')
 <script type="text/javascript">
  ...
  <script type="text/javascript">
   appurl = '{{URL::route("verify_front_mobile") }}';
   _token = "{{ csrf_token() }}";
   appId = "{{ $appId }}";
</script>
<script>
    $(document).on('click', '.verify_mobile_no',function () {
        ...
        $.ajax({
             ...
             success:function(result) {
                ...
                if (result['status']) {
                   mobile_target.attr('readonly','readonly');
                   button_target.text('verified');
                   $('#modalMobile').show();
                   $('#modalMobile iframe').attr({'src':'{{URL::route("verify_mobile_front") }}?mobile='+mobile_no,'width':'100%'});
                }
             },
             error:function(error) {
