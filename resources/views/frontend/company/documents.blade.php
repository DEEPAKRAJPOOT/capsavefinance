...
@endif
	...
	<div class="col-md-3 text-right row files" id="files{{$g}}">
        ...
        <span class="btn btn-default btn-file">
            Browse  <input id="pics{{$g}}" type="file"  name="files[]" data-id="{{$document['user_req_doc_id'].'#'.$document['user_kyc_id'].'#'.$document['doc_id']
		...
		<div class="row marT30">
		    <div class="col-md-6">
	         ...
	         <div class="col-md-6 text-right">
			  <a href="{{route('financial-show')}}" class="btn btn-prev">Previous</a>	
	          <button  type="button"  id="uploadBtn" class="btn btn-save">Submit</button>
