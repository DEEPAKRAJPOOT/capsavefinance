 ...
 <div class="row justify-content-center align-items-center m-0">
    <div class="col-md-4 form-design lenevo_layout_login">
        <div class="sign-up-box">
            <form class="form-horizontal" method="POST" id="resetForgotFm" action="{{ url('password/reset-lenevo') }}">
                <div class="section-header" style="background: #2a8b6a;">
                    <h4 class="section-title heading_color"> {{trans('master.resetForm.heading')}}</h4>
               </div>
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-4">
                        <button type="submit" class="btn btn-next btn-fill btn-primary btn-wd">
