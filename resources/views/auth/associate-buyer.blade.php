    ...
    <div class="container">
        ...
        <div class="mt-4">
            <div class="form-heading pb-3">
                <h2>Associate Buyers
                    <small> ( Please Add the Buyer's Information )
                    ...
                    <form>
                        <div class=" form-fields pt-4">
                            <table class="table table-bordered" cellspacing="0" cellpadding="0">
                                ...
                                <th>Email *</th>
                                <th>Mobile *</th>
                                <th width="150" class="text-center">Buyer Agreement</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td ><div class="relative"><a href="javascript:void(0);" class="verify-owner-no verify-gst">Verify</a><input type="text" class="form-control" placeholder="Enter GST"></div></td>
                            ...
                            <div class="d-flex btn-section ">
                                ...
                                <div class="col-md-4 ml-auto text-right">
                                    ...
                                    <input type="button" value="Skip" class="btn btn-primary" onclick="window.location.href = 'associate-logistics.php'">  <input type="button" value="Save and Continue" class="btn btn-primary" onclick="window.location.href = 'associate-logistics.php'"> </div>
                            </div>
                        </div>
                    </form>
                </div>
