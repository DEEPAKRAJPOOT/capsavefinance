...
return [
    ...
    'email_not_given'=> 'Sorry, OTP consent is not able to be sent because email id not given!',
    'pan_not_given' => 'Sorry pull request is not being process because pan no is not given',
    'consent_not_applied'=> 'Ckyc consent not applied !',
    'ckyc_data_not_found' => 'CKYC data not found !',
    'ckyc_API_not_working' => 'CKYC Api not working please try after sometime.',
    'enter_consent_corr_otp' => 'Please provide the correct OTP provided in your mail.',
    'consent_otp_expired' => 'OTP you have entered is expired.',
    'unable_fetch_ckyc_doc'=>'Unable to fetch CKYC documents for this user !',
    'something_went_wrong'=> 'Sorry! Something went wrong.',
    'ckyc_already_process'=> 'CKYC is already processsed by the user, you cannot pull it again.',
    ];
