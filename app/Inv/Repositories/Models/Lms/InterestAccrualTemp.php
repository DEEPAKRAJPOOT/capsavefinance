...
class InterestAccrualTemp extends BaseModel {
    /* The database table used by the model.
     *
     * @var string
     */

    protected $table = 'interest_accrual_temp';
     ...
     * @var integer
     */
    protected $primaryKey = 'interest_accrual_temp_id';
     ...
     */
    public static function saveInterestAccrualTemp($data, $whereCondition=[])
    {
        if (!is_array($data)) {
    ...
    {                 
        ...
        $query->orderBy('interest_accrual_temp_id', 'ASC');
        $result = $query->get();                
        return $result;
    }
