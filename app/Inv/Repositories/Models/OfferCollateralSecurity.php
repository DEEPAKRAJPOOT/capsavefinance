...
class OfferCollateralSecurity extends BaseModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'offer_collateral_security';
     ...
     * @var integer
     */
    protected $primaryKey = 'offer_collateral_security_id';
    ...
    /**
     * Create offer Collateral Security
     * 
     * @param array $data
     * @return boolean
     */
    ...
    public static function addOfferCollateralSecurity($data){
        if(!is_array($data)){
            ...
            $offerCs =  self::insert($data);
            return $offerCs ? true : false;
        }
    }
