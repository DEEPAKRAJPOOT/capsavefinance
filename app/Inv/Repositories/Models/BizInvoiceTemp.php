            ...
            if($updateTemp)
            {
               ...
               $data = new BizInvoice;
                       $data->anchor_id =  $result->anchor_id;
                        ...
                        $data->invoice_due_date =  ($result['invoice_due_date']) ? Carbon::createFromFormat('d/m/Y', $result['invoice_due_date'])->format('Y-m-d') : '';
                        $data->invoice_date =   ($result['invoice_date']) ? Carbon::createFromFormat('d/m/Y', $result['invoice_date'])->format('Y-m-d') : '';
