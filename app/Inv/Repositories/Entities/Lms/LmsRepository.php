...
class LmsRepository extends BaseRepositories implements LmsInterface {
   ...
   {
	  return Disbursal::with(['lms_user','lms_user.user', 'lms_user.bank_details', 'lms_user.user.anchor_bank_details', 'lms_user.userCreatedBy'])->whereIn('disbursal_id', $disburseIds)->with('user.anchor')
			->get();
   }
