...
namespace App\Inv\Repositories\Entities\Kyc;

use Carbon\Carbon;

use App\Inv\Repositories\Contracts\KycInterface;
...
class KycRepository implements KycInterface
{
    ...
    {
        $result = Kyc::update((int) $id, $attributes);
    ...
    public function saveOwnerInfo($attributes = []){
        ...
        return true;//BizOwner::creates($attributes);
