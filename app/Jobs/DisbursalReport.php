...
class DisbursalReport implements ShouldQueue
{
    ...
    private function downloadDailyDisbursalReport($exceldata, $reportName)
    {
        ...
        foreach($exceldata as $rowData){
            ...
            ->setCellValueExplicit('AP'.$rows, $rowData['customer_id'], \PHPExcel_Cell_DataType::TYPE_STRING) //ADD NEW C
            ->setCellValueExplicit('AQ'.$rows, $rowData['invoice_no'], \PHPExcel_Cell_DataType::TYPE_STRING) //ADD NEW C
            ...
            ->setCellValueExplicit('AT'.$rows, $rowData['disbursement_method'], \PHPExcel_Cell_DataType::TYPE_STRING) //ADD NEW C
