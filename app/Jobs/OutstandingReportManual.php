...
class OutstandingReportManual implements ShouldQueue
{
    ...
    private function downloadOutstandingReport($exceldata)
    {
        ...
        ->setCellValue('N'.$rows, 'Interest Amount Posted')
        ...
        ->setCellValue('X'.$rows, 'Overdue Interest Outstanding')
        ...
        ->setCellValue('AB'.$rows, 'Grace Days - Principle')
        ...
        foreach($exceldata as $rowData){
            ...
            ->setCellValue('AF'.$rows, $rowData['interestDPD'])
