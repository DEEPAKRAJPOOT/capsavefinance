        ...
        return DataTables::of($app)
                ...
                ->addColumn(
                    ...
                    //    if (Helpers ::checkPermission('reject_app')) {
                           $act = $act . '<a title="Reject Application" href="#" data-toggle="modal" data-target="#rejectApplication" data-url="' . route('reject_app', ['app_id' => $app->app_id, 'biz_id' => $request->get('biz_id'), 'user_id' => $app->user_id, 'curr_status_id' => $app->curr_status_id]) . '" data-height="250px" data-width="100%" data-placement="top" class="btn btn-action-btn btn-sm"><i class="fa fa-sticky-note" aria-hidden="true"></i></a>';
                        }
