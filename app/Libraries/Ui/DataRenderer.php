            ...
            return DataTables::of($dataRecords)
                    ...
                    ->editColumn(
                        ...
                        function ($dataRecords) {
                            ...
                            if(Helpers::checkPermission('undo_apportionment') && $dataRecords->is_settled == '1' && $dataRecords->action_type == '1' && $dataRecords->trans_type == '17' && $dataRecords->validRevertPaymentId == $dataRecords->payment_id ){
