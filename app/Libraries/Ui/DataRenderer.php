        ...
        return DataTables::of($app)
                ...
                ->addColumn(
                    ...
                    function ($app) use ($request) {
                        ...
                        }else if($app->curr_status_id !== null && $app->curr_status_id == config('common.mst_status_id')['APP_REJECTED']){
                           $act = $app->reason;
                        }else if($app->curr_status_id !== null && $app->curr_status_id == config('common.mst_status_id')['APP_CANCEL']){
                           $act = $app->reason;
                        }else if($app->curr_status_id !== null && $app->curr_status_id == config('common.mst_status_id')['APP_HOLD']){
                           $act = $app->reason;
                        }else if($app->curr_status_id !== null && $app->curr_status_id == config('common.mst_status_id')['APP_DATA_PENDING']){
                           $act = $app->reason;
                        }
