            ...
            foreach ($allinvoices as $invoice) {
                if($invoice['supplier_id'] = $userid) {
                    ...
                    if ($intrstAmt > 0.00) {
                        ...
                        $intrstCdtTrnsData = $this->createTransactionData($userid, ['parent_trans_id' => $createTransaction->trans_id, 'link_trans_id' => $createTransaction->trans_id, 'amount' => $intrstAmt, 'trans_date' => $disburseDate, 'invoice_disbursed_id' => $invoiceDisbursedId], 9, 1);
