...
class BusinessInformationRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'tenor_days' => 'nullable|numeric|gt:0|lt:121',
    ...
    public function messages()
    {
        return [
            ...
            'tenor_days.gt' => 'Tenor days greated than 0 days',
            'tenor_days.lt' => 'Tenor days less than 120 days',
            'tenor_days.regex' => 'Tenor days should be numeric',
